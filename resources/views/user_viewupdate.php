            ...
            <div id="fh5co-main">
                <div class="fh5co-narrow-content">
                    ...
                    <form>
                        ...
                        @csrf
                        <table  method="get" action="{{url('UserID', $users)}}"> </table>
                        <p>
                            <label for="name">ID:</label>
                            <br/>
                        <tr>
                            <input type="text"  size="12" maxlength="10"  name="id" value="" required=""> {{$users['id']}}
                            </tr>
                            </p>
                        <p>
                        ...
                        <td><a href="user/retrievedata/edit?id={{$prog['id']}}"</a></td>
                        @endforeach
                        <p>
